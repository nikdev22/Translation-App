...
public class ObjectActivity extends AppCompatActivity {
    ...
    private void callCloudVision(final Bitmap bitmap) {
        ...
        try {
            AsyncTask<Object, Void, String> labelDetectionTask = new ObjectActivity.LableDetectionTask(this, prepareAnnotationRequest(bitmap));
    ...
    private static class LableDetectionTask extends AsyncTask<Object, Void, String> {
        private final WeakReference<ObjectActivity> mActivityWeakReference;
        private Vision.Images.Annotate mRequest;

        LableDetectionTask(ObjectActivity activity, Vision.Images.Annotate annotate) {
        ...
        protected void onPostExecute(String result) {
            ObjectActivity activity = mActivityWeakReference.get();
    ...
    private static String convertResponseToString(BatchAnnotateImagesResponse response) {
        StringBuilder message = new StringBuilder("I found these things:\n\n");
         List<EntityAnnotation> entity = response.getResponses().get(0).getLabelAnnotations();
//        LocalizedObjectAnnotation localizedObjectAnnotation = response.getResponses().get(0).get
//        String resultAnnotation = response.getResponses().get(0).getImagePropertiesAnnotation();
//        List<AnnotateImageResponse> annotateImageResponses = response.getResponse
//        LocalizedObjectAnnotation localizedObjectAnnotation = annotateImageResponses.get
//        List<LocalizedObjectAnnotation> localizedObjectAnnotations = response.getResponses().get(0).get
...
//        String resultAnnotation = textAnnotation.getText();
       String resultAnnotation = entity.get(0).getDescription();
